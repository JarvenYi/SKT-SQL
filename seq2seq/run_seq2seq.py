...
# -----------------------------------------
# print('\n', sys.argv , end='\n')
# sys.argv = ['seq2seq/run_seq2seq.py', 'configs/spider/train_spider_rasat_small.json'] # Single GPU
# # Multi-GPU
# # sys.argv = [ '-m torch.distributed.launch', '--nnodes=1', '--nproc_per_node=2', 'seq2seq/run_seq2seq.py', 'configs/spider/train_spider_rasat_small.json']
# print(sys.argv)
# print(sys.argv[0])
# -----------------------------------------

# sys.argv[] capture the parameters as list in terminal
# sys.argv[0] means the path of current demo
...
# ========================Set CUDA GPU By Jarven (as CUDA_VISIBLE_DEVICES="0" in Terminal)============================
...
def main() -> None:
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):    # only use single GPU
        # If we pass only one argument to the script and it's the path to a json file,
        # let's parse it to get our arguments.
        # -----By Jarven - for process error of can not find configs/spider/***.json------
        # if os.path.exists(os.path.abspath(sys.argv[1])):  _ = 1
        # else: sys.argv[1] = sys.argv[0]
        # ----------------------------------------------------------------------------
