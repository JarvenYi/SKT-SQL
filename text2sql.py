...
from utils.load_dataset import Text2SQLDataset , Text2SQLWithHdsDataset
...
def parse_option():
    ...
    parser.add_argument('--seed', type = int, default = 42,
                        help = 'random seed.')
    parser.add_argument('--save_path', type = str, default = "models/Easy",
                        help = 'save path of best fine-tuned text2sql model.')
    parser.add_argument('--tensorboard_save_path', type = str, default = "tensorboard_log/DQCP/Easy_resd_hardness_text2sql",
    ...
    parser.add_argument('--train_filepath', type = str, default = "./data/preprocessed_data/preprocessed_by_resd_hardness/Easy_resd_hardness_train_dataset.json",
    ...
    parser.add_argument("--target_type", type = str, default = "sql",
                help = "sql or natsql.")
    parser.add_argument("--output", type = str, default = "Easy_predicted_sql.txt",
...
def _train(opt):
    ...
    train_dataset = Text2SQLWithHdsDataset(
    ...
    for epoch in range(opt.epochs):
        ...
        for batch in tqdm(train_dataloder):
            ...
            if  epoch >= 1 and train_step % num_checkpoint_steps == 0:
...
def _test(opt):
    ...
    dev_dataset = Text2SQLWithHdsDataset(
